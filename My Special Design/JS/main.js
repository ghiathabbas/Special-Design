...
function changeColor(choosenColor) {
  ...
  colorsBullets[Object.keys(colors).indexOf(choosenColor)].classList.add('active');
  document.styleSheets[2].rules[1].style.setProperty('--main-color',  `${colors[choosenColor]}`);
